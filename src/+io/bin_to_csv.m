function bin_to_csv(fnames, n_col, ns, options, SoilLayer, GroundwaterSettings, FullCSVfiles, closeWaterBalance)
    %% flu
    ...
    %% water balance (optional)
    if closeWaterBalance
        wbal_names = {'simulation_number', 'nu_iterations', 'year', 'DoY', 'Precip', 'Eff_Precip', 'R_Hort', 'R_Dunn', 'Runoff', 'RWUs', 'RWUg', ...
                      'Trap', 'Evap', 'ET', 'Recharge', 'Capillary', 'deltaS', 'deltaS_in', 'deltaS_out', 'correctedDeltaS', 'correctedDeltaS_in', ...
                      'correctedDeltaS_out', 'Total_inflow', 'Total_outflow', 'Residual', 'Error_org', 'Error_corrected'};
        wbal_units = {'', '', '', '', 'mm/30min', 'mm/30min', 'mm/30min', 'mm/30min', 'mm/30min', 'mm/30min', 'mm/30min', 'mm/30min', ...
                      'mm/30min', 'mm/30min', 'mm/30min', 'mm/30min', 'mm/30min', 'mm/30min', 'mm/30min', 'mm/30min', ...
                      'mm/30min', 'mm/30min', 'mm/30min', 'mm/30min', 'mm/30min', 'mm/30min', 'percentage', 'percentage'};
