...
flu_names = {'simulation_number','nu_iterations','year','DoY',...
   ...
   'aPAR','aPAR_Cab','aPAR/rad.PAR','aPAR_Wm2','PAR','rad.Eoutf','rad.Eoutf./fluxes.aPAR_Wm2','Trap','Evap','ET','GPP'};
flu_units = {'','','','',  ...
    'W m-2','W m-2','W m-2',...
    'W m-2','W m-2','W m-2','umol m-2 s-1',...
    'W m-2',' W m-2','W m-2','W m-2','umol m-2 s-1',...
    'umol m-2 s-1',' umol m-2 s-1','umol m-2 s-1','W m-2','umol m-2 s-1','W m-2','W m-2','cm s-1','cm s-1','cm s-1','Kg m-2 s-1'};
