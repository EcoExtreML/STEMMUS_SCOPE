global RHOV_A Msrmn_Fitting Msr_Mois Msr_Temp Msr_Time %Trap EVAP_ind TRAP_ind Sim_Theta_ind Sim_Theta EVAP_dir TRAP_dir ET_H E_D ET_D sumTRAP_dir sumEVAP_dir
