function [XOLD,EX,XWRE]=SOIL1_SPAT(Theta_L,Theta_LL,NL,IH,Theta_s,XK,XOLD)
...
% head and moisture content be continuous in time. Theta_L Theta_LL 
% global EX ML NL ND XOLD IS J XWRE IH Theta_s XK
XWRE=zeros(NL,2);
for ML=1:NL
    % Soil type index;
    J=ML;  
