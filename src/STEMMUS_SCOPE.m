...
global constants
global RWU
global HR U Precip G Rn LAI Ta1 Ts1 h_v rl_min HR_a Ts Ta Tss Taa Tcc bbx RWUtot Rls frac Tsss sfactortot sfactor
run Constants
Mdata=xlsread('E:\grassland\SCOPE-master\SCOPE_v1.73\src\Meterology data','sheet1','B5:AD17572');
Ta1=Mdata(:,1);   % air temperature
HR=Mdata(:,2)./100;   % relative humidity
U=Mdata(:,3);     % wind speed at 2m
Precip=Mdata(:,4)./10;    % precipitation
...
iter.maxit           = 600;                          %                   maximum number of iterations
...
global KT Delt_t TEND TIME MN NN NL ML ND hOLD TOLD h hh T TT P_gOLD P_g P_gg Delt_t0
        ...
        switch options.calc_ebal
            case 1
                [iter,fluxes,rad,thermal,profiles,soil,RWU,frac]                          ...
                    ...
                    leafopt,angles,meteo,soil,canopy,leafbio,xyt,k,profiles,LR);
