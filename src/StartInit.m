...
global hThmrl Tr COR Hystrs 
global Theta_V DTheta_LLh Theta_g KIT Se KL_h CKTN 
...
for J=1:NS
    ...
    m(J)=1-1/n(J);
    XK(J)=0.075; %0.11 This is for silt loam; For sand XK=0.025
