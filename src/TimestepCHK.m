function [KT,TIME,Delt_t,tS,NBChh,IRPT1,IRPT2]=TimestepCHK(NBCh,BCh,NBChh,DSTOR,DSTOR0,EXCESS,QMT,Precip,Evap,hh,KT,TIME,Delt_t,tS,IRPT1,NN)

global xERR hERR TERR 
global Theta_LL Theta_L h TT T
global NL 
global Thmrlefc NBChB NBCT NBCTB

if NBCh==1
    [KT,TIME,Delt_t,IRPT1,IRPT2,tS]=CnvrgnCHK(xERR,hERR,TERR,Theta_LL,Theta_L,hh,h,TT,T,KT,TIME,Delt_t,NL,NN,Thmrlefc,NBCh,NBChB,NBCT,NBCTB,tS);
