...
%{
    ...
    structure = [createStructure(zeros(mL, nD), fields)];
    ...
    structures[2] = createStructure(zeros(mL, 1), fields);
    ...
    structures[4] = createStructure(zeros(Nmsrmn, 1), fields);
    ...
    structures[5] = createStructure(zeros(Dur_tot, 1), fields);
    ...
    structures[6] = createStructure(zeros(mN, 1), fields);
