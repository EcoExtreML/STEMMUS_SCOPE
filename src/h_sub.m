function h_sub(SoilVariables, InitialValues, ForcingData, VaporVariables, GasDispersivity, ...
                BoundaryCondition, Delt_t, RHOV, DRHOVh, DRHOVT, D_Ta, KL_T, hN, hOLD, RWU, lEstot, lEctot)
    ...
    DTheta_LLT, CHK, AVAIL0, QMT, QMB, Srt, r_a_SOIL
    ...
    % TODO issue otherwise the output will be empty arrays!
