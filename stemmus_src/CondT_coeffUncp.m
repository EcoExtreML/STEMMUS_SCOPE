function [c_unsat,Lambda_eff,ZETA,ETCON,EHCAP,TETCON,EfTCON]=CondT_coeffUncp(Theta_LL,Lambda1,Lambda2,Lambda3,RHO_bulk,Theta_g,RHODA,RHOV,c_a,c_V,c_L,NL,nD,ThmrlCondCap,ThermCond,HCAP,SF,TCA,GA1,GA2,GB1,GB2,HCD,ZETA0,CON0,PS1,PS2,XWILT,XK,TT,POR,DRHOVT,L,D_A,Theta_V,Theta_II,TCON_dry,Theta_s,XSOC,TPS1,TPS2,TCON0,TCON_s,FEHCAP,RHOI,RHOL,c_unsat,Lambda_eff,ETCON,EHCAP,TETCON,EfTCON,ZETA)

if ThmrlCondCap==1
%     run EfeCapCond;
    [ETCON,EHCAP,TETCON,EfTCON,ZETA]=EfeCapCondUncp(HCAP,SF,TCA,GA1,GA2,GB1,GB2,HCD,ZETA0,CON0,PS1,PS2,XWILT,XK,TT,NL,POR,Theta_LL,DRHOVT,L,D_A,RHOV,Theta_V,Theta_II,TCON_dry,Theta_s,XSOC,ThermCond,TPS1,TPS2,TCON0,TCON_s,FEHCAP,RHOI,RHOL,ETCON,EHCAP,TETCON,EfTCON,ZETA);
    for ML=1:NL
        for ND=1:nD
